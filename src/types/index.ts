...
export const CUISINE_OPTIONS = [
  ...
  'American', 'French', 'Thai', 'Greek', 'Spanish', 'Middle Eastern',
  'Vegetarian', 'Vegan', 'Keto', 'Paleo'
]

export const DIET_OPTIONS = [
  'None', 'Vegetarian', 'Vegan', 'Pescatarian', 'Keto', 'Paleo',
  'Low Carb', 'Low Fat', 'Gluten Free', 'Dairy Free', 'Nut Free'
]

export const ALLERGY_OPTIONS = [
  'None', 'Gluten', 'Dairy', 'Eggs', 'Nuts', 'Peanuts', 'Shellfish',
  'Fish', 'Soy', 'Wheat', 'Sesame'
]

export const COOKING_LEVEL_OPTIONS = ['beginner', 'intermediate', 'advanced'] as const
