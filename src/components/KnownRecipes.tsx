                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-1">
                      ...
                      >
                        <Heart
                          className={`h-4 w-4 ${recipe.isFavorite ? "fill-destructive text-destructive" : "text-muted-foreground"}`}
                        />
                      </Button>
                      <Button
                        variant="ghost"
      ...
      {recipes.length === 0 && (
        ...
        >
          ...
          <p className="mb-4 text-muted-foreground">
            Start by adding your favorite recipes or let AI generate some for
            you!
          </p>
          <Button onClick={() => setIsModalOpen(true)}>
            <Plus className="mr-2 h-4 w-4" />
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-background shadow-xl"
